...
Source0  : https://files.pythonhosted.org/packages/cc/00/d7966c0190b292e8efafb1192e5cd38a8cb1716f65e93ab4668bba4c0ff3/pyroute2.ethtool-0.6.12.tar.gz
...
%prep
%setup -q -n pyroute2.ethtool-0.6.12
cd %{_builddir}/pyroute2.ethtool-0.6.12
pushd ..
cp -a pyroute2.ethtool-0.6.12 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1655133024
...
cp %{_builddir}/pyroute2.ethtool-0.6.12/LICENSE.Apache.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2.ethtool/cd9bad64b174708395f795bb92f7b4be7d996e8f
cp %{_builddir}/pyroute2.ethtool-0.6.12/LICENSE.GPL.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2.ethtool/4cc77b90af91e615a64ae04893fdffa7939db84c
