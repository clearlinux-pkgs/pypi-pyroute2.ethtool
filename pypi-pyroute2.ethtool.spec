...
Source0  : https://files.pythonhosted.org/packages/a9/23/35006c28508e745ce694d124ec694359ca8cbfef80f2ce5a9aef37bc3406/pyroute2.ethtool-0.6.13.tar.gz
...
%prep
%setup -q -n pyroute2.ethtool-0.6.13
cd %{_builddir}/pyroute2.ethtool-0.6.13
pushd ..
cp -a pyroute2.ethtool-0.6.13 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707134895
...
cp %{_builddir}/pyroute2.ethtool-%{version}/LICENSE.Apache.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2.ethtool/cd9bad64b174708395f795bb92f7b4be7d996e8f || :
cp %{_builddir}/pyroute2.ethtool-%{version}/LICENSE.GPL.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2.ethtool/4cc77b90af91e615a64ae04893fdffa7939db84c || :
