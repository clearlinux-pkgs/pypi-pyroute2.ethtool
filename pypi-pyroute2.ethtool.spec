...
Version  : 0.6.8
Release  : 14
URL      : https://files.pythonhosted.org/packages/7d/9b/ec8b9a39c8031c01f392a0e829564d58f429b45b5ceef8f1293b64bcc657/pyroute2.ethtool-0.6.8.tar.gz
Source0  : https://files.pythonhosted.org/packages/7d/9b/ec8b9a39c8031c01f392a0e829564d58f429b45b5ceef8f1293b64bcc657/pyroute2.ethtool-0.6.8.tar.gz
...
%prep
%setup -q -n pyroute2.ethtool-0.6.8
cd %{_builddir}/pyroute2.ethtool-0.6.8
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647103504
...
cp %{_builddir}/pyroute2.ethtool-0.6.8/LICENSE.Apache.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2.ethtool/cd9bad64b174708395f795bb92f7b4be7d996e8f
cp %{_builddir}/pyroute2.ethtool-0.6.8/LICENSE.GPL.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2.ethtool/4cc77b90af91e615a64ae04893fdffa7939db84c
