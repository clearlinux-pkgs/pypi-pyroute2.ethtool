...
Version  : 0.6.10
Release  : 16
URL      : https://files.pythonhosted.org/packages/bd/24/bec425c048dc894abaca06d783886efc2175aea4428f9abee3656945affb/pyroute2.ethtool-0.6.10.tar.gz
Source0  : https://files.pythonhosted.org/packages/bd/24/bec425c048dc894abaca06d783886efc2175aea4428f9abee3656945affb/pyroute2.ethtool-0.6.10.tar.gz
...
%prep
%setup -q -n pyroute2.ethtool-0.6.10
cd %{_builddir}/pyroute2.ethtool-0.6.10
pushd ..
cp -a pyroute2.ethtool-0.6.10 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654528319
...
cp %{_builddir}/pyroute2.ethtool-0.6.10/LICENSE.Apache.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2.ethtool/cd9bad64b174708395f795bb92f7b4be7d996e8f
cp %{_builddir}/pyroute2.ethtool-0.6.10/LICENSE.GPL.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2.ethtool/4cc77b90af91e615a64ae04893fdffa7939db84c
